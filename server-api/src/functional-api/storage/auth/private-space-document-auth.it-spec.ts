...
import {
  ...
  sorted__create_read_readAbout_update_delete_grant_contribute_updateContent,
...
describe('Private Space - visual on profile', () => {
  ...
  describe('Access to Call for Whitaboards Whiteboard visual(banner) documents', () => {
    ...
    test.each`
      userRole                     | privileges
      ${undefined}                 | ${undefined}
      ${TestUser.GLOBAL_ADMIN}     | ${sorted__create_read_readAbout_update_delete_grant_contribute_updateContent}
      ${TestUser.SPACE_ADMIN}      | ${sorted__create_read_readAbout_update_delete_grant_contribute}
      ${TestUser.NON_SPACE_MEMBER} | ${undefined}
      ${TestUser.SPACE_MEMBER}     | ${['CONTRIBUTE', 'READ', 'READ_ABOUT']}
    `(
